    public class Zeidel {
        ...
        private final double[] absSum = {0, 0, 0, 0};
    ...
    //                System.out.println(abssum);
        ...
        public void solution() {
            ...
            while (flag) {
                x0[0] = x0[0] * matrixB[0][0] + x0[1] * matrixB[0][1] + x0[2] * matrixB[0][2] + x0[3] * matrixB[0][3] + matrixC[0];
                x0[1] = x0[0] * matrixB[1][0] + x0[1] * matrixB[1][1] + x0[2] * matrixB[1][2] + x0[3] * matrixB[1][3] + matrixC[1];
                x0[2] = x0[0] * matrixB[2][0] + x0[1] * matrixB[2][1] + x0[2] * matrixB[2][2] + x0[3] * matrixB[2][3] + matrixC[2];
                x0[3] = x0[0] * matrixB[3][0] + x0[1] * matrixB[3][1] + x0[2] * matrixB[3][2] + x0[3] * matrixB[3][3] + matrixC[3];
